...
create table public.travel_preferences (
  ...
  budget_style text not null default 'balanced' check (budget_style in ('shoestring', 'budget', 'balanced', 'premium')),
  comfort_level text not null default 'standard' check (comfort_level in ('budget', 'standard', 'premium')),
  travel_pace text not null default 'balanced' check (travel_pace in ('slow', 'balanced', 'packed')),
  safety_preference text not null default 'standard' check (safety_preference in ('standard', 'extra_checkins', 'share_with_contacts')),
